      ...
      entries: [
        {
          ...
          search: "pottery table shaping station pottering recipe selection scroll list stonecutter clay shaping output",
          details: true,
          detailsTitle: "Usage",
          detailsText: `
      ...
      entries: [
{
  ...
  icon: "/assets/icons/pottery/red_plant_bowl.png",
...
},
{
  ...
  icon: "/assets/icons/pottery/red_garden_pot.png",
  ...
  items: [
    {
      ...
      title: "CHANGE_THIS",
      icon: "/assets/icons/pottery/red_garden_pot.png",
      search: "large flower pot pottery",
    },
    {
      id: "garden_pot",
      title: "CHANGE_THIS",
...
Like other pottery pieces, Urns can be painted and crafted in different colors. If a painted Urn is glazed using Honeycomb, it gains a soft glow and keeps its finished look.`,
  ...
  items: [
    ...
    },
    {
      id: "amphore",
      title: "Amphore",
      icon: "/assets/icons/pottery/amphore.png",
...
They come in Wall, Stair, and Slab variants.`,
  ...
  items: [
    { id: "red_brick_blocks", title: "Red Brick Blocks", icon: "/assets/icons/pottery/red_brick.png", search: "red brick blocks wall stair slab" },
    { id: "yellow_brick_blocks", title: "Yellow Brick Blocks", icon: "/assets/icons/pottery/yellow_brick.png", search: "yellow brick blocks wall stair slab" },
    { id: "white_brick_blocks", title: "White Brick Blocks", icon: "/assets/icons/pottery/white_brick.png", search: "white brick blocks wall stair slab" },
    { id: "blue_brick_blocks", title: "Blue Brick Blocks", icon: "/assets/icons/pottery/blue_brick.png", search: "blue brick blocks wall stair slab" },
     { id: "black_brick_blocks", title: "Black Brick Blocks", icon: "/assets/icons/pottery/black_brick.png", search: "black brick blocks wall stair slab" },
  ],
},
      ],
    },
      ...
      entries: [
        {
          ...
          items: [
            { id: "red_clay_ball", title: "Red Clay Ball", namespace_id: "lilis_pottery:red_clay_ball", icon: "/assets/icons/pottery/red_clay_ball.png", search: "red clay ball clay deposit" },
          ],
        },
        {
          id: "yellow_clay",
          ...
          items: [
            { id: "yellow_clay_ball", title: "Yellow Clay Ball", namespace_id: "lilis_pottery:yellow_clay_ball", icon: "/assets/icons/pottery/yellow_clay_ball.png", search: "yellow clay ball clay deposit" },
          ],
        },
        {
          id: "white_clay",
          ...
          detailsBullets: [
            "Snowy Plains, Ice Spikes, Snowy Taiga",
            "Frozen Rivers",
            "Swamps and Mangrove Swamps",
          ],
          items: [
            { id: "white_clay_ball", title: "White Clay Ball", namespace_id: "lilis_pottery:white_clay_ball", icon: "/assets/icons/pottery/white_clay_ball.png", search: "white clay ball clay deposit" },
          ],
        },
        {
          id: "blue_clay",
          ...
          icon: "/assets/icons/pottery/blue_clay_ball.png",
          search: "blue clay taiga old growth pine taiga old growth spruce taiga windswept hills windswept forest river swamp lush caves",
          details: true,
          detailsTitle: "Where to find",
          ...
          items: [
            { id: "blue_clay_ball", title: "Blue Clay Ball", namespace_id: "lilis_pottery:blue_clay_ball", icon: "/assets/icons/pottery/blue_clay_ball.png", search: "blue clay ball clay deposit" },
          ],
        },
        {
          id: "black_clay",
          ...
          items: [
            { id: "black_clay_ball", title: "Black Clay Ball", namespace_id: "lilis_pottery:black_clay_ball", icon: "/assets/icons/pottery/black_clay_ball.png", search: "black clay ball clay deposit" },
          ],
        },
      ],
    },
